...
<body>
	...
	<div class="mx-auto my-3 p-3 bg-dark text-light" style="width:700px"  >
		<p class="text-center text-light fs-1">Doctor DashBoard</p>
		...
		<div class="row" >
			<div class="col-md-4 offset-md-2" style="float:none;margin:auto;">
