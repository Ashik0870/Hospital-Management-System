...
<body>
	...
	<div class="container p-5 my-5 bg-dark text-white">
		<p class="text-center text-white fs-3">Admin Dashboard</p>
		...
		<div class="row">
			<div class="col-md-2" style="float:none;margin:auto;">
				<div class="card my-card" style="width:200px">
			...
			<div class="col-md-2" style="float:none;margin:auto;">
				<div class="card my-card" style="width:250px">
					<div class="card-body text-center text-dark">
					<!-- 	<i class="fa-solid fa-calendar-check fa-3x"></i><br>-->
						<p class="fs-4 text-center">
							Appointment <br><%= totalNumberOfAppointment %>
						</p>
					</div>
				</div>
			...
			<!-- <div class="col-md-2" style="float:none;margin:auto;">
				<div class="card my-card" data-bs-toggle="modal" style="width:250px"
					data-bs-target="#exampleModal">
					<div class="card-body text-center text-dark">
					<!-- 	<i class="fa-solid fa-user-doctor fa-3x"></i><br>-->
						<!-- x	<p class="fs-4 text-center">
