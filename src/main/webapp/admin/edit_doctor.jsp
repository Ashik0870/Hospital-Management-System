...
<style type="text/css">
.my-card {
	box-shadow: 0px 0px 10px 1px dark;
...
<body>
	...
	<div class="container p-2 my-1 bg-secondary text-white">
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<div class="card my-card">
					<div class="card-body">
						<p class="fs-1 text-center text-secondary">Edit Doctor Details</p>
						...
						<form action="../updateDoctor" method="post">
							<div class="mb-3">
								<label class="form-label">Full Name</label> <input
									...
									class="form-control" value="<%=doctor.getFullName()%>" pattern="[a-zA-Z0-9\s]+" required>

							</div>
							<div class="mb-3">
								<label class="form-label">Date of Birth</label> <input
									name="dateOfBirth" type="date" placeholder="Enter DOB"
									class="form-control" value="<%=doctor.getDateOfBirth()%>" required>
							...
							<div class="mb-3">
								<label class="form-label">Email address</label> <input
									...
									class="form-control" value="<%=doctor.getEmail()%>" required>

							</div>
							<div class="mb-3">
								<label class="form-label">Phone</label> <input name="phone"
									type="text" placeholder="Enter mobile number"
									class="form-control" value="<%=doctor.getPhone()%>" pattern="[0-9]{10}" required>
