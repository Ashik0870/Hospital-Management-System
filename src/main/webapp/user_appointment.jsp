...
.btn my-bg-color text-white col-md-12{
...
<body>
	...
	<div class="container p-1" >
		...
		<div class="row" >
			...
			<!-- col-2 -->
			<div class="col-md-0"  >
				<div class="card my-card" style="background-color: grey;">
					<div class="card-body">
						...
						<c:if test="${not empty successMsg }">
							<p class="text-center text-dark fs-5">${successMsg}</p>
							<c:remove var="successMsg" scope="session" />
						</c:if>

						<!-- for error msg -->
						<c:if test="${not empty errorMsg }">
							<p class="text-center text-dark fs-5">${errorMsg}</p>
						...
						<form class="row g-3" action="addAppointment" method="post">
							...
							<div class="col-md-6">
								<label class="form-label">Full Name</label> <input required="required"
									...
									class="form-control" pattern="[a-zA-Z0-9\s]+" required>

							</div>

							<div class="col-md-6">
								<label class="form-label">Gender</label> <select
									class="form-control" name="gender" required="required" required>
							...
							<div class="col-md-6">
								...
								required="required"	type="number" placeholder="Enter your Age" class="form-control" required>
							</div>
							<div class="col-md-6">
								<label class="form-label">Appointment Date</label> <input
								required="required"	name="appointmentDate" type="date" class="form-control" required  min='2023-05-11'>
							</div>

							<div class="col-md-6">
								<label class="form-label">Email</label> <input name="email"
								required="required"	type="email" placeholder="Enter email" class="form-control" required>
							</div>

							<div class="col-md-6">
								<label class="form-label">Phone</label> <input name="phone"
								required="required"	type="tel" maxlength="11" placeholder="Enter Mobile no."
							...
							<div class="col-md-12">
								...
								<textarea name="address" required="required" class="form-control" rows="3" cols="" required></textarea>
							</div>
